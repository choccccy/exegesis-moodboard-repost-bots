...
from bot.curation.handlers import apply_post_edits, handle_cancel_button, handle_confirm_button, handle_confirmation_reaction, handle_edit_button, handle_graphic_button, handle_label_reaction, handle_metadata_confirm_button, handle_metadata_reaction, handle_playlist_skip_button
...
@patch("bot.curation.handlers._auto_add_to_playlist", new_callable=AsyncMock, return_value=0)
@patch("bot.curation.statemachine._playlist_close_ready", new_callable=AsyncMock, return_value=False)
...
@patch("bot.curation.handlers._do_playlist_remove", new_callable=AsyncMock)
